...
export const ui = {
  ...
  fr: {
    ...
    heroSummary:
      'Je suis étudiant en informatique à l’Université de Montpellier, spécialisé en informatique graphique, traitement d’images, développement de jeux et IA. Je recherche un stage de 6 mois à partir de février 2027.',
